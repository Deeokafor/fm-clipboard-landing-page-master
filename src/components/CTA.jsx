...
export default function CallToAction() {
    return (
        <section className='tw:min-h-96 tw:px-10 tw:my-44 tw:flex tw:flex-col tw:justify-center tw:text-center'>
            ...
            <div className='tw:grid tw:justify-center tw:gap-8 tw:mt-14'>
                <IosButton />
                <MacButton />   
            </div>
        </section>
